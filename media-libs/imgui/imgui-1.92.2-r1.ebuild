...
SRC_URI="https://github.com/ocornut/imgui/archive/refs/tags/v${PV}b.tar.gz -> imgui-${PV}b.tar.gz"
S="${WORKDIR}/${P}b"
...
RDEPEND="
	...
	sdl3? ( media-libs/libsdl2[${MULTILIB_USEDEP}] )
	sdl3-renderer? ( media-libs/libsdl2[${MULTILIB_USEDEP}] )
