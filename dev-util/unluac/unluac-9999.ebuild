...
PATCHES=(
	"${FILESDIR}/${PN}-9999-testsuite.patch"
)
...
src_test() {
	JAVA_MAIN_CLASS="unluac.test.RunTests" JAVA_JAR_FILENAME="unluac.test.jar" java-pkg-simple_src_compile || die
	java -jar unluac.jar --version || die
	java -jar unluac.test.jar || die
}
