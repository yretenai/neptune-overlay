...
CERES_VERSION="0c70ed3a1a2d6ba47c06c7e8b3b040880bc474db"
SRC_URI="https://github.com/ceres-solver/ceres-solver/archive/${CERES_VERSION}.tar.gz"
S="${WORKDIR}/${PN}-${CERES_VERSION}"
