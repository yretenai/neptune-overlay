...
SRC_URI="
	...
	https://gitlab.com/EvelynTSMG/imhex-ffx-pats/-/archive/${FFX_COMMIT}/imhex-ffx-pats-${FFX_COMMIT}.tar.gz -> ${PN}-ffx-${FFX_COMMIT}.tar.gz
	https://gitlab.com/EvelynTSMG/imhex-bastion-pats/-/archive/${BASTION_COMMIT}/imhex-bastion-pats-${BASTION_COMMIT}.tar.gz -> ${PN}-bastion-${BASTION_COMMIT}.tar.gz
"
