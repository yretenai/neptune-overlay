...
IUSE="wayland X appindicator system-vulkan system-ffmpeg"
...
src_install() {
	exeinto "${DESTDIR}"
	doexe electron chrome-sandbox libEGL.so libGLESv2.so libvk_swiftshader.so
