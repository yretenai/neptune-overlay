...
COMMIT="4baa98e2e8fdf1ddafd00aa162baf9a905d33e19"
...
PATCHES=(
	"${FILESDIR}/${PN}-3.0.2-precompile.patch"
	"${FILESDIR}/${PN}-2.3-datadir.patch"
	"${FILESDIR}/${PN}-3.0.2-output.patch"
...
src_prepare() {
	...
	sed -e "s|__AMDGPU_FLAGS__|$(get_amdgpu_flags)|" -i scripts/bitcodes/common_tools.py || die
