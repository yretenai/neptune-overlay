...
gamefinder.common@4.2.2
gamefinder.registryutils@4.2.2
gamefinder.storehandlers.eadesktop@4.2.2
gamefinder.storehandlers.egs@4.2.2
gamefinder.storehandlers.gog@4.2.2
gamefinder.storehandlers.origin@4.2.2
gamefinder.storehandlers.steam@4.2.2
gamefinder.storehandlers.xbox@4.2.2
gamefinder.wine@4.2.2
gamefinder@4.2.2
...
nexusmods.mnemonicdb.abstractions@0.9.52
nexusmods.mnemonicdb.sourcegenerator@0.9.52
nexusmods.mnemonicdb.storage@0.9.52
nexusmods.mnemonicdb@0.9.52
...
src_configure() {
	if use p7zip; then
		sed -e "s|onLinux: () => \"7zz\",|onLinux: () => \"7z\",|" -i "src/ArchiveManagement/NexusMods.FileExtractor/Extractors/SevenZipExtractor.cs" || die
	fi
