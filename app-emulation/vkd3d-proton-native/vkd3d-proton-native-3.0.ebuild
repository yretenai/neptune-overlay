...
if [[ ${PV} == *9999* ]]; then
	...
	HASH_VKD3D=6d97b022a1c501b8574a2dd5d9e0446c83055043 # match tag on bumps
...
src_prepare() {
	if [[ ${PV} != *9999* ]]; then
		...
		rmdir subprojects/dxil-spirv/subprojects/dxbc-spirv/subprojects/spirv-headers || die
