...
LICENSE="GPL-2"
SLOT="0"
IUSE="discord faudio +llvm opencv vulkan wayland +sdl"
...
src_prepare() {
	...
	# Unbundle gamemode
	sed -i -e 's|3rdparty/feralinteractive/feralinteractive/lib/gamemode_client.h|gamemode_client.h|' rpcs3/gamemode_control.cpp || die
